 ...
 * reused verbatim from the chat empty state - one component, two placements; this screen adds
      ...
      <div className="mb-5 flex items-end justify-between gap-4 border-b border-neutral-900 pb-4">
        <div>
          ...
          <p className="mt-1 text-xs text-neutral-500">
            Pick a run - it opens a chat that asks you the rest. Everything happens on your Mac.
          </p>
        </div>
